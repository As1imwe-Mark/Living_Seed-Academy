      ...
      <div className="mt-8">
        {isLoading ? (
          ...
          <div className="flex flex-wrap justify-center p-4 space-y-4 md:space-y-0 md:space-x-4">
            {images.slice(currentIndex, currentIndex + 6).map((image, index) => (
              <div
                key={index}
                className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 relative cursor-pointer bg-white p-2 rounded-lg overflow-hidden mb-4"
        ...
        {isModalOpen && selectedImage && (
          <div className="fixed inset-0 flex justify-center items-center z-50">
            ...
            <div className="relative bg-opacity-85 p-4 max-w-md w-full shadow-xl">
